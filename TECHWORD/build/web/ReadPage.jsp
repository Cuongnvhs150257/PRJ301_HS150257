...
<html>
    <head>
        <jsp:useBean id="a" class="DAO.PostsDAO" scope="request"></jsp:useBean>
            ...
            <link href="styleread1.css" rel="stylesheet" type="text/css"/>
        </head>
        <body>
            <div>
                ...
                <div class="content">
                    ...
                    <div class="right">
                        ...
                        <c:if test="${sessionScope.acc != null && sessionScope.acc.name == Detail.pname || sessionScope.acc.name == "Admin"}">
                            ...
                            <div class="deletebutton">
                                <a href="#">
                                    <button onclick="show(${Detail.pid})" type="submit">Xóa bài viết</button>
                                </a>
                            </div>
                        </c:if> 
                        <script>
